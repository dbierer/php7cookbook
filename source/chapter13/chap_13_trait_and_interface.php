...
try {
    ...
    echo "Country List\n";
    echo "------------\n";
    $list = Application\Generic\ListFactory::
		factory(new Application\Generic\CountryListUsingTrait(), $params);
    ...
    echo "-------------\n";
    $list = Application\Generic\ListFactory::
		factory(new Application\Generic\CustomerListUsingTrait(), $params);
    foreach ($list->list() as $item) echo $item . ' ';
